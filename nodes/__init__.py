...
# Merge all mappings
for mappings in [LOAD_MAPPINGS, LOAD_MESH_MAPPINGS, PROCESS_MAPPINGS, VIS_MAPPINGS, PREVIEW_MAPPINGS, EXPORT_MAPPINGS, SKELETON_IO_MAPPINGS]:
    NODE_CLASS_MAPPINGS.update(mappings)

for mappings in [LOAD_DISPLAY_MAPPINGS, LOAD_MESH_DISPLAY_MAPPINGS, PROCESS_DISPLAY_MAPPINGS, VIS_DISPLAY_MAPPINGS, PREVIEW_DISPLAY_MAPPINGS, EXPORT_DISPLAY_MAPPINGS, SKELETON_IO_DISPLAY_MAPPINGS]:
