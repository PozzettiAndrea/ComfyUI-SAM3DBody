    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "attn_backend": (["auto", "flash_attn", "sage_attn", "sdpa", "xformers", "torch_flash_attn"], {
                    "default": "auto",
                    "tooltip": "Attention backend. auto: let ComfyUI pick the best available. Otherwise force a specific backend."
                }),
